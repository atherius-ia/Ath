...
if IS_DOWN and not shared.BYPASS_VW_PROTECTION then
    ...
    task.spawn(function()
        pcall(function()
            ...
            loadstring(game:HttpGet("https://raw.githubusercontent.com/atherius-ia/Ath/"..tostring(commit).."/inkgamereducer.lua", true))()
        end)
    end)

    loadstring(game:HttpGet("https://raw.githubusercontent.com/atherius-ia/Ath/"..tostring(commit).."/newinkgame.lua", true))()
end
