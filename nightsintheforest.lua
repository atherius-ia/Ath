...
╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝ ╚═════╝ ╚══════╝
                ...
                🚀 Atherius — 99 Nights In The Forest 🚀
----------------------------------------------------------------------------
  IMPORTANT:
...
if game.PlaceId == 79546208627805 then
    pcall(function()
        game:GetService("StarterGui"):SetCore("SendNotification", {
            Title = "Atherius | 99 Nights In The Forest",
            Text = "Go In Game for Atherius to load :D [You are in lobby currently]",
            Duration = 10
        })
    end)
    return
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/atherius-ia/Ath/"..tostring(commit).."/newnightsintheforest.lua", true))()
